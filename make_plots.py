...
with open("resources/results__no_model.model", "rb") as fp:
    history = pickle.load(fp)

with open("resources/results_names_entities.model", "rb") as fp:
    history_nouns = pickle.load(fp)

model_x = list(map(lambda x: x['date'], history_nouns))
...
make_models_plot(model_x, no_model_y, [], model_names_entities_y, [], "resources/plots/all_models")
#
